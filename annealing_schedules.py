...
class LinearAdditiveSchedule(Schedule):
    ...
    def __init__(self, T_start, T_freeze, dwell ):
        ...
        self.T_freeze = T_freeze
        self.dwell = dwell
        self.name = 'Linear Additive Schedule T_S:%.2f T_F:%2.f Alpha:%.2f' %(T_start, T_freeze, dwell)
...
class QuadraticAdditiveSchedule(Schedule):
    ...
    def __init__(self, T_start, T_freeze, dwell ):
        ...
        self.dwell = dwell
        #super(BinaryAnnealer, self).__init__(1/self.T0
        self.name = 'Quadratic Additive Schedule T_S:%.2f T_F:%2.f Alpha:%.2f' %(T_start, T_freeze, dwell)
...
class ExponentialAdditiveSchedule( Schedule ):
    ...
    def __init__(self, T_start, T_freeze, dwell ):
        ...
        self.T_freeze = T_freeze
        self.dwell = dwell
        self.name = 'Exponential Additive Schedule T_S:%.2f T_F:%2.f Alpha:%.2f' %(T_start, T_freeze, dwell)
        #super(BinaryAnnealer, self).__init__(1/self.T0
...
class TrignometricAdditiveSchedule( Schedule ):
    ...
    def __init__(self, T_start, T_freeze, dwell ):
        ...
        self.T_freeze = T_freeze
        self.dwell = dwell
        self.name = 'Trignometric Additive Schedule T_S:%.2f T_F:%2.f Alpha:%.2f' %(T_start, T_freeze, dwell)
        #super(BinaryAnnealer, self).__init__(1/self.T0
